      ...
      ? createPortal(
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div
              ...
              className="relative w-full max-w-md overflow-hidden rounded-[var(--radius)] border border-[var(--border-main)] bg-[var(--bg-panel)] shadow-[var(--shadow-md)]"
            >
              <div className="flex items-center justify-between border-b border-[var(--border-main)] px-4 py-3">
                 <div>
                  <h2 id="add-folder-title" className="text-lg font-semibold text-[var(--fg-primary)]">Add folder</h2>
              ...
              <div className="px-4 pb-4 pt-4">
                <div className="mt-5 space-y-4">
                  <div>
                    <label htmlFor="add-folder-path" className="text-[11px] font-semibold text-[var(--fg-secondary)]">
                      Folder path
                    </label>
                  ...
                  <div>
                    <label htmlFor="add-folder-name" className="text-[11px] font-semibold text-[var(--fg-secondary)]">
                      Display name
                    </label>
                    <input
                      id="add-folder-name"
