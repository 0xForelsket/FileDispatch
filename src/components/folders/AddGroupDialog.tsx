        ...
        open && typeof document !== "undefined"
            ? createPortal(
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    />
                    <div className="relative w-full max-w-sm overflow-hidden rounded-[var(--radius)] border border-[var(--border-main)] bg-[var(--bg-panel)] shadow-[var(--shadow-md)]">
                        ...
                        <form onSubmit={handleSubmit} className="p-4">
                            ...
                            <div className="mt-6 flex justify-end gap-3">
                                ...
                                <button
                                    type="submit"
                                    disabled={!name.trim()}
                                    className="rounded-[var(--radius)] bg-[var(--accent)] px-4 py-1.5 text-xs font-semibold text-[var(--accent-contrast)] shadow-[var(--shadow-sm)] transition-all hover:opacity-90 disabled:opacity-50"
                                >
                                    Create Group
                                </button>
                            </div>
